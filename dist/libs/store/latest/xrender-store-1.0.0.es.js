...
var Store = /* @__PURE__ */ (function() {
  ...
  return _createClass(Store2, [{
    ...
    value: function subscribe(callback) {
      ...
      return function() {
        return _this2.subscribers.delete(callback);
      };
    }
  }, {
    ...
    value: function commit(type, payload) {
      if (!this.mutations[type]) {
        console.error('[Store] Mutation "'.concat(type, '" is not defined.'));
        return;
      }
      try {
    ...
    value: function enableStrictMode() {
      ...
      var handler = {
        set: function set(target, key, value) {
          if (_this4.strict && !_this4.mutations[key]) {
            console.warn('[Store] Direct mutation of state "'.concat(key, '" is not allowed in strict mode.'));
          }
          target[key] = value;
          return true;
        }
    ...
    value: function persistState() {
      ...
      var key = options.key || "storeState";
      ...
      window.addEventListener("beforeunload", function() {
        try {
          localStorage.setItem(key, JSON.stringify(_this5.state));
        } catch (error) {
    ...
    value: function initModules() {
      ...
      Object.keys(this.modules).forEach(function(moduleName) {
        var module = _this7.modules[moduleName];
        if (!module) return;
        _this7.state[moduleName] = _this7.observe(module.state || {});
        _this7.mutations = _objectSpread2(_objectSpread2({}, _this7.mutations), module.mutations);
        _this7.actions = _objectSpread2(_objectSpread2({}, _this7.actions), module.actions);
        if (module.getters) {
          Object.keys(module.getters).forEach(function(key) {
            Object.defineProperty(_this7.getters, key, {
              get: function get() {
                return module.getters[key](_this7.state[moduleName]);
              }
            });
          });
        }
    ...
    value: function initState(state) {
      var _this8 = this;
      Object.keys(this.modules).forEach(function(moduleName) {
        state[moduleName] = _this8.modules[moduleName].state || {};
      });
      return state;
    }
  }, {
    ...
    value: function dispatch(type, payload) {
      if (!this.actions[type]) {
        console.error('[Store] Action "'.concat(type, '" is not defined.'));
        return Promise.reject(new Error('Action "'.concat(type, '" is not defined.')));
      }
      try {
...
_defineProperty(Store, "version", "1.0.0");
var xStore = {
...
//# sourceMappingURL=xrender-store-1.0.0.es.js.map
