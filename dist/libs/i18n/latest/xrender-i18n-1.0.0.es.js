...
var I18n = /* @__PURE__ */ (function() {
  ...
  return _createClass(I18n2, [{
    ...
    value: function getMessage(key) {
      var localeMessages = this.messages[this.locale] || {};
      var fallbackMessages = this.messages[this.fallbackLocale] || {};
      return localeMessages[key] || fallbackMessages[key] || key;
    }
  }, {
    key: "loadLocale",
    value: (function() {
      var _loadLocale = _asyncToGenerator(/* @__PURE__ */ _regenerator().m(function _callee(locale) {
        var response, messages, _t;
        return _regenerator().w(function(_context) {
          while (1) switch (_context.p = _context.n) {
            ...
            case 1:
              ...
              _context.p = 2;
              _context.n = 3;
              return fetch("/locales/".concat(locale, ".json"));
            case 3:
              response = _context.v;
              _context.n = 4;
            ...
            case 5:
              _context.p = 5;
              _t = _context.v;
              console.error("Failed to load locale: ".concat(locale), _t);
            case 6:
              _context.p = 6;
              this.loading = false;
              return _context.f(6);
    ...
    value: function t(key) {
      ...
      var formatter = new IntlMessageFormat(message, this.locale, this.formats);
      return formatter.format(_objectSpread2(_objectSpread2({}, values), {}, {
    ...
    key: "addMessages",
    value: function addMessages(locale, messages) {
      this.messages[locale] = _objectSpread2(_objectSpread2({}, this.messages[locale] || {}), messages);
    }
  }]);
})();
_defineProperty(I18n, "version", "1.0.0");
var xI18n = {
...
//# sourceMappingURL=xrender-i18n-1.0.0.es.js.map
